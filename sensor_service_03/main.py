...
SENSOR_NAME: str = 'sensor_03'
SENSOR_KEY: str = 'sensor_03_key'
LOG_KEY: str = 'log_03_key'
...
app = FastAPI(
    title='sensor_service_03',
    description='Микросервис, имитирующий работу сенсора №3',
    redoc_url=None,
)
...
def generate_sensor_data():
    return {
        ...
        'geotag': """75°57'16.5"S 34°42'01.9"E""",
        'timestamp': int(time.time()),
        'temperature': round(uniform(-90.0, 0.0), 3),
        'humidity': round(uniform(0.0, 30.0), 3),
    }
