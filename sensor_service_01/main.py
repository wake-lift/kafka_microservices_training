...
SENSOR_NAME: str = 'sensor_01'
SENSOR_KEY: str = 'sensor_01_key'
LOG_KEY: str = 'log_01_key'
...
app = FastAPI(
    title='sensor_service_01',
    description='Микросервис, имитирующий работу сенсора №1',
    redoc_url=None,
)
...
def generate_sensor_data():
    return {
        ...
        'geotag': """75°49'07.9"N 62°24'34.0"E""",
        'timestamp': int(time.time()),
        'temperature': round(uniform(-60.0, 10.0), 3),
